  ...
  output$tabItms <- renderUI ({
    ...
    items <- c(
      ...
      list(tabItem(tabName = "dashboard", 
                   column(4, "박스그래프",
                          box(width = 12,
                              selectInput('plot_option1', "그래프 요소를 선택하시오:", cohort_dictionary1$변수설명), 
                   ...
                   column(4, "분포그래프",
                          box(width = 12,
                              selectInput('plot_option2', "그래프 요소를 선택하시오:", cohort_dictionary2$변수설명), 
      ...
      list(tabItem(tabName = "dbcenter",  
                   box(width=3,
                       box(width=12,
                           dateInput('heartdate', label = '심박동 데이터 불러오기: yyyy-mm-dd', value = Sys.Date()-1), 
                   ...
                   box(width=3,
                       box(width=12,
                           checkboxGroupInput("path", "Choose graph to draw:",
                                              choiceNames = list(icon("heartbeat"),icon("shoe-prints"),icon("bacon"),icon("fire")),
                                              choiceValues = list("heart", "steps","distance","calories")
                           ),
                           dateInput('intradate', label = '하루 데이터 불러오기: yyyy-mm-dd', value = Sys.Date()-1),
                   ...
                   box(width=3,
                       box(width=12,
                           dateInput('intradate1', label = '수면 데이터 시작날짜 : yyyy-mm-dd', value = Sys.Date()-2), 
                           dateInput('intradate2', label = '수면 데이터 끝 날짜 : yyyy-mm-dd', value = Sys.Date()-1), 
                   ...
                   box(width=3,
                       box(width=12,
                           dateInput('intradate3', label = '음식 데이터 불러오기: yyyy-mm-dd', value = Sys.Date()-1), 
